	            ...
	            <div class="collapse navbar-collapse" id="navbarSupportedContent">
	                <ul class="navbar-nav mr-auto">
	                    <li class="nav-item active">
	                        ...
	                        <a class="nav-link" href="Index.php" title="Cadastrar">Cadastrar Avatar <span class="sr-only">(current)</span></a>
	                    </li>
	                    <li class="nav-item">
	                        <a class="nav-link" href="secoes/listarAvatar.php" title="Listar">Mostrar Personagens</a>
	                    </li>
        ...
        <div class="container">
        	<div class="col-md-8">
		        ...
		        <form method="post" action="../control/controleAvatar.php">
		        	<h1 style="font-family: Courier New; font-weight: bold;">CRIE SEU AVATAR</h1>
					...
					<div class="form-group">
				  	...
				  	<button type="submit" class="btn btn-outline-dark" name="opcao" value="Cadastrar">Cadastrar</button>
				</form>
			</div>
		</div>
